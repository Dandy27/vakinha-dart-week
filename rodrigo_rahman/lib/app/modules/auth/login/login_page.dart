...
import 'package:rodrigo_rahman/app/core/ui/vakinha_state.dart';
...
import 'package:rodrigo_rahman/app/modules/auth/login/login_controller.dart';
                      ...
                      children: [
                        ...
                        VakinhaTextformfield(
                          ...
                          validator: Validatorless.multiple([
                            Validatorless.required('Email obrigatŕio'),
                            Validatorless.email('Email inváido'),
                          ]),
                        ),
                        const SizedBox(
                          height: 30,
                        ...
                        VakinhaTextformfield(
                          ...
                          validator: Validatorless.multiple([
                            Validatorless.required('Senha obrigatŕio'),
                            Validatorless.min(
                              6,
                              'Senha deve conte pelo menos 6 caracteres',
                            ),
                          ]),
                        ),
                        const SizedBox(
